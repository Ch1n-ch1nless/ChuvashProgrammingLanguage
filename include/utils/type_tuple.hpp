...
A little piece of metaprogramming course. We use it to create type hierarchies
with concepts. If you wanna see more crazy stuff like that, check out Roman
Sandu's course. Task "type_lists" there is just about that kind of things.
...
template <typename T>
concept TypeTuple = requires(T t) { []<typename... Ts>(TTuple<Ts...>) {}(t); };
...
// static_assert(Contains<TTuple<double, int, float, char>, char>::value ==
// true);
