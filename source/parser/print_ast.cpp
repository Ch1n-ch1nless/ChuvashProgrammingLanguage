...
void printExpression(const ExpressionVariant& expression, std::size_t indentation) {
    // Helper function:
    auto printBinaryOp = [&](const auto& op, const std::string& opName, std::size_t indent) {
    ...
    std::visit(
        overloaded{
            ...
            [&](const Identificator& id) {
                printWithIndentation(toString<Identificator>(), indentation);
                printWithIndentation("{", indentation);
                {
                  ++indentation;
                  printWithIndentation(id.value, indentation);
                  --indentation;
                }
                printWithIndentation("}\n", indentation);
            },
...
void printStatement(const StatementVariant& statement, std::size_t indentation) {
  std::visit(
    overloaded{
      [&](const ScopeStatement& block) {
        printWithIndentation("ScopeStatement:\n", indentation);
        printWithIndentation("{\n", indentation);
      ...
      [&](const ReturnStatement& ret) {
        printWithIndentation("ReturnStatement:\n", indentation);
        printWithIndentation("{\n", indentation);
        {
          ++indentation;
      ...
      [&](const ExpressionStatement& expr) {
        printWithIndentation("ExpressionStatement:\n", indentation);
        printWithIndentation("{\n", indentation);
        {
          ++indentation;
      ...
      [&](const IfStatement& ifStmt) {
        printWithIndentation("IfStatement\n", indentation);
        printWithIndentation("{\n", indentation);
        {
          ++indentation;
      ...
      [&](const WhileStatement& whileStmt) {
        printWithIndentation("WhileStatement\n", indentation);
        printWithIndentation("{\n", indentation);
        {
          ++indentation;
          printWithIndentation("Condition:\n", indentation);
      ...
      [&]([[maybe_unused]]const VariableDeclaration& varDecl) {
        // ...
      },
    },
    statement
...
void printFunctionDeclaration(const FunctionDeclaration &function, std::size_t indentation) {
